...
caminho_broto = os.path.join(pasta_assets, 'broto_roxo.png')
caminho_muda = os.path.join(pasta_assets, 'muda_roxa.png')
caminho_planta = os.path.join(pasta_assets, 'planta_roxa.png')
class PlantaCaverna(IPlanta):
    ...
    def __init__(self, pos, grupo):
        ...
        self.__imagem_planta = pygame.transform.scale(pygame.image.load(caminho_planta), (300, 300))
